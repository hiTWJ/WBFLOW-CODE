...
data = np.load('/home/lcx/deep_final/deep_final/folds/test_cube_all_.npy', allow_pickle=True).item()
...
"_wbflow_error.txt"
error_txt = '/home/lcx/artflow/error/' + 'unet_error_cube.txt'
try:
    f = open(error_txt, 'r')
    f.close()
except IOError:
